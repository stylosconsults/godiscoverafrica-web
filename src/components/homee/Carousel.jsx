  ...
  const caption = (
    <Carousel.Caption className='carousel-caption-centered d-flex justify-content-center align-items-center'>
      <div className='text-center'>
        ...
        <h2 className='text-white'>Preserving ecosystems, enhancing sustainability</h2>
        <h2 className='text-white'>and fostering biodiversity for generations to come.</h2>
        <br/>
        <Link to="/services">
